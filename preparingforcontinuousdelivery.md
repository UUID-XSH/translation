...
如果您希望调节持续交付的速度，您可能需要每天或每周多次执行此操作，并且这与它的工作速度和可靠性息息相关。
...
XebiaLabs的XL Deploy等应用程序发布自动化工具可以促进将代码推送到环境的这个过程。XL Deploy还提供自助服务功能，使团队能够将准备发布的应用程序推送到他们的环境中，而无需开发输入，创建更改单元或等待中间件管理员。
...
以自动化方式在环境之间转移软件的敏捷性是刚接触持续交付的团队主要缺乏的部分之一，因此这也应该是您自己准备持续交付时应该关注的重点。
